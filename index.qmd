...
- **Entry-level coding tasks** → Automated by AI
- **Junior analyst roles** → LLMs handle basic data work
- **Routine research tasks** → AI-assisted or fully automated
- **Simple documentation** → Generated by language models

**Result:** Companies need fewer true beginners
:::
:::
...
**You compete at mid-level, not entry-level**
:::
:::
::::
...
:::{style="font-size: 0.6em; color: #999; text-align: center;"}
Source code available [here](https://github.com/IndrajeetPatil/academia-to-industry){target='_blank'}.
:::
